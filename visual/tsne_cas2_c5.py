...
# @Author : BingYu Nan
# @Location : Wuxi
# @Time : 2024/12/16 14:13
import torch.utils.data as data
from matplotlib import pyplot as plt
from sklearn.manifold import TSNE
from torchvision import transforms
from GAMDSS import *
from cas2.dataset_c5 import Cas2DataSet
from models.model import *


# sys.stdout = Logger("full_cas2_c5.log")
...
def run_training(raf_path):
    ...
    for subj in LOSO:
        train_dataset = Cas2DataSet(raf_path, phase='train', num_loso=subj, transform=data_transforms,
                                   basic_aug=True, transform_norm=data_transforms_norm)
        val_dataset = Cas2DataSet(raf_path, phase='test', num_loso=subj, transform=data_transforms_val)
        ...
        for i in range(1, 200):
            ...
            if i == 199:
                ...
                # 自定义颜色列表
                colors = ['red', 'green', 'pink', 'yellow', 'brown']  # 根据实际情况修改颜色
                label_names = ['Repression', 'Disgust', 'Happy', 'Surprise', 'Other']  # 根据实际情况修改标签名称
