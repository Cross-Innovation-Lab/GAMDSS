...
from samm.dataset_c3 import sammc3DataSet

sys.stdout = Logger("full_samm_c3.log")
...
def run_training(raf_path):
    ...
    for subj in LOSO:
        train_dataset = sammc3DataSet(raf_path, phase='train', num_loso=subj, transform=data_transforms,
                                   basic_aug=True, transform_norm=data_transforms_norm)
        val_dataset = sammc3DataSet(raf_path, phase='test', num_loso=subj, transform=data_transforms_val)
