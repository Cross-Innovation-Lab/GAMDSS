...
from backbone.model.model import *
from backbone.samm.dataset_c5 import res_sammDataSet
from GAMDSS import *


sys.stdout = Logger("conv_samm_c5.log")
...
def run_training(raf_path):
    ...
    for subj in LOSO:
        train_dataset = res_sammDataSet(raf_path, phase='train', num_loso=subj, transform=data_transforms,
                                   basic_aug=True, transform_norm=data_transforms_norm)
        val_dataset = res_sammDataSet(raf_path, phase='test', num_loso=subj, transform=data_transforms_val)
