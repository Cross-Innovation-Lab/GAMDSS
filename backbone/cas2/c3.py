...
from backbone.cas2.dataset_c3 import res_Cas2c3DataSet
from backbone.model.model import res_DRT, cov_DRT
from GAMDSS import *


sys.stdout = Logger("conv_cas2_c3.log")
...
def run_training(raf_path):
    ...
    for subj in LOSO:
        train_dataset = res_Cas2c3DataSet(raf_path, phase='train', num_loso=subj, transform=data_transforms,
                                   basic_aug=True, transform_norm=data_transforms_norm)
        val_dataset = res_Cas2c3DataSet(raf_path, phase='test', num_loso=subj, transform=data_transforms_val)
