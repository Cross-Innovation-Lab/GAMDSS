...
from GAMDSS import *
from cas2.dataset_c3 import Cas2c3DataSet
from models.model import *


sys.stdout = Logger("full_cas2_c3.log")
...
def run_training(raf_path):
    ...
    for subj in LOSO:
        train_dataset = Cas2c3DataSet(raf_path, phase='train', num_loso=subj, transform=data_transforms,
                                   basic_aug=True, transform_norm=data_transforms_norm)
        val_dataset = Cas2c3DataSet(raf_path, phase='test', num_loso=subj, transform=data_transforms_val)
